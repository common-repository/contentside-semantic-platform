	...
	public function register_categorize_actions() {
		register_rest_route(
			...
			[
				...
				'permission_callback' => function () {
					return current_user_can( CspPluginCapabilities::CSP_PLUGIN_CAPABILITY_CATEGORIZE );
				},
			]
		);
		...
		register_rest_route(
			...
			[
				...
				'args'                => [ 'asTags' => true ],
				'permission_callback' => function () {
					return current_user_can( CspPluginCapabilities::CSP_PLUGIN_CAPABILITY_TAGGING );
				},
			]
		);
	}
